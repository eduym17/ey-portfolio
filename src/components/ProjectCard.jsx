    ...
    <div className="flex items-center justify-center gap-4 py-6 w-full md:flex-col lg:flex-row lg:text-base">
      ...
      >
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`flex items-center justify-center gap-1 disabled:cursor-not-allowed ${isWebDisabled ? 'pointer-events-none' : ''}`}
        >
          <svg
            width="20px"
            height="20px"
      ...
      <button
        type="button"
        className={`py-1.5 w-[130px] rounded-md font-medium text-dev-gray-20 ${isRepoDisabled ? 'cursor-not-allowed bg-dev-gray-40' : 'bg-dev-violet hover:bg-lightGradient hover:text-dev-white'}`}
      ...
      >
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className={`flex items-center justify-center gap-1 disabled:cursor-not-allowed ${isRepoDisabled ? 'pointer-events-none' : ''}`}
        >
          <svg
            width="20px"
            height="20px"
...
ProjectCard.propTypes = {
  ...
  isWebDisabled: propTypes.bool,
  linkRepo: propTypes.string,
  isRepoDisabled: propTypes.bool,
